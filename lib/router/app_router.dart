    ...
    GoRoute(
      ...
      builder: (context, state) {
        ...
        return RoleLoginScreen(
          roleName: extra['roleName'] is String
              ? extra['roleName'] as String
              : 'Counter',
          themeColor: extra['themeColor'] is Color
              ? extra['themeColor'] as Color
              : Colors.green,
      ...
      branches: [
        StatefulShellBranch(
          routes: [
            GoRoute(
              path: '/lab/dashboard',
              builder: (context, state) => const LabDashboardHome(),
            ),
          ],
        ),
        StatefulShellBranch(
          ...
          routes: [
            GoRoute(
              ...
              routes: [
                GoRoute(
                  path: 'create',
                  builder: (context, state) => LabCreateTemplateScreen(
                    existingTemplate: state.extra as LabTemplate?,
                  ),
                ),
              ],
            ),
        ...
        StatefulShellBranch(
          routes: [
            GoRoute(
              path: '/lab/packages',
              builder: (context, state) => const LabPackagesScreen(),
            ),
          ],
        ),
        StatefulShellBranch(
        ...
        StatefulShellBranch(
          routes: [
            GoRoute(
              path: '/lab/tracking',
              builder: (context, state) => const LabSampleTrackingScreen(),
            ),
          ],
        ),
        StatefulShellBranch(
        ...
        StatefulShellBranch(
          routes: [
            GoRoute(
              path: '/lab/send_reports',
              builder: (context, state) => const LabSendReportsScreen(),
            ),
          ],
        ),
        StatefulShellBranch(
          routes: [
            GoRoute(
              path: '/lab/history',
              builder: (context, state) => const LabHistoryScreen(),
            ),
          ],
        ),
      ],
      ...
      branches: [
        StatefulShellBranch(
          routes: [
            GoRoute(
              path: '/crm/dashboard',
              builder: (context, state) => const CrmDashboardHome(),
            ),
          ],
        ),
        StatefulShellBranch(
          routes: [
            GoRoute(
              path: '/crm/patients',
              builder: (context, state) => const CrmPatientsScreen(),
            ),
          ],
        ),
        StatefulShellBranch(
          routes: [
            GoRoute(
              ...
              builder: (context, state) => const CrmAppointmentsScreen(),
            ),
          ],
        ),
        StatefulShellBranch(
          routes: [
            GoRoute(
              path: '/crm/prescriptions',
              builder: (context, state) => const CrmPrescriptionsScreen(),
            ),
          ],
        ),
        StatefulShellBranch(
          routes: [
            GoRoute(
              path: '/crm/doctors',
              builder: (context, state) => const CrmDoctorsScreen(),
            ),
          ],
        ),
        StatefulShellBranch(
          routes: [
            GoRoute(
              path: '/crm/payment_receipt',
              builder: (context, state) => const CrmPaymentReceiptScreen(),
            ),
          ],
        ),
        StatefulShellBranch(
          routes: [
            GoRoute(
              path: '/crm/payment_history',
              builder: (context, state) => const CrmPaymentHistoryScreen(),
            ),
          ],
        ),
        StatefulShellBranch(
          routes: [
            GoRoute(
              path: '/crm/lab_billing',
              builder: (context, state) => const CrmLabBillingScreen(),
            ),
          ],
        ),
        StatefulShellBranch(
          routes: [
            GoRoute(
              path: '/crm/send_to_lab',
              builder: (context, state) => const CrmSendToLabScreen(),
            ),
          ],
        ),
        StatefulShellBranch(
