...
class PdfGenerator {
  ...
  static Future<Uint8List> generateBill({
    ...
    final pdf = pw.Document(
      theme: pw.ThemeData.withFont(base: _cachedFont, bold: _cachedFontBold),
    );
    ...
    if (format == 'Thermal') {
      ...
      // A4 or A5 format
      PdfPageFormat pageFormat = format == 'A4'
          ? PdfPageFormat.a4
            ...
            return [
              ...
              pw.Table(
                border: pw.TableBorder(
                  ...
                  horizontalInside:
                      pw.BorderSide.none, // Removed horizontal lines
                ),
                columnWidths: {
