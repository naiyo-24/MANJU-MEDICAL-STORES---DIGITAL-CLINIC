...
class _AccountsScreenState extends ConsumerState<AccountsScreen> {
  ...
  AccountsState get _state =>
      ref.watch(accountsProvider).value ?? AccountsState();
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: ['Income', 'Expense']
                      ...
                      .toList(),
                  onChanged: (val) =>
                      setStateDialog(() => typeCtrl.text = val!),
                ),
                ...
                TextField(
                  ...
                  decoration: const InputDecoration(
                    labelText: 'Category (e.g. Sales, Rent)',
                    border: OutlineInputBorder(),
                  ),
                ),
                const SizedBox(height: 16),
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: ['Cash', 'Bank Transfer', 'UPI', 'Card']
                      ...
                      .toList(),
                  onChanged: (val) =>
                      setStateDialog(() => paymentModeCtrl.text = val!),
                ),
                const SizedBox(height: 16),
  ...
  Widget build(BuildContext context) {
    ...
    final pagedTxns = _transactions.isNotEmpty
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        IconButton(
                                                          ...
                                                          onPressed: () {
                                                            AccountsWidgets.showTransactionDetails(
                                                              context,
                                                              txn,
                                                            );
                                                          },
