    ...
    return Column(
        children: [
          ...
          _receivables.isEmpty
              ? const Padding(padding: EdgeInsets.all(32), child: Center(child: Text('No outstanding receivables!', style: TextStyle(color: Color(0xFF64748B)))))
              : ListView.separated(
                  shrinkWrap: true,
                              ...
                              child: Row(
                                children: [
                                  CircleAvatar(
                                    ...
                                    child: Text((item['entity_name']?.toString().isNotEmpty == true) ? item['entity_name'].toString()[0].toUpperCase() : '?', style: const TextStyle(color: Color(0xFF0369A1), fontWeight: FontWeight.bold, fontSize: 12)),
                                  ),
