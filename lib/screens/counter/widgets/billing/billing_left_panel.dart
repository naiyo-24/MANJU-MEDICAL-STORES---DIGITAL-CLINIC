      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(20),
            border: Border.all(color: isSelected ? const Color(0xFF22C55E) : const Color(0xFFE2E8F0)),
          ),
          child: Text(
            label,
            style: TextStyle(
        ...
        children: [
          ...
          Padding(
            ...
            child: SingleChildScrollView(
              ...
              child: Row(
                children: categories.asMap().entries.map((entry) => _buildFilterChip(entry.value, entry.key)).toList(),
              ),
            ),
          ),
