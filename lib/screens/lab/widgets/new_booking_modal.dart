  ...
  Future<void> _submit() async {
    ...
    if (_selectedTestIds.isEmpty && _selectedPackageIds.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Please select at least one test or package.'),
        ),
      );
      return;
    }
                          ...
                          children: [
                            if (_availablePackages.isNotEmpty) ...[
                              ...
                              ..._availablePackages.map(
                                (p) => _buildSelectionItem(
                                  title: p.name,
                                  price: p.discountedPrice,
                                  isSelected: _selectedPackageIds.contains(
                                    p.id,
                                  ),
                                  onChanged: (val) {
                                    setState(() {
