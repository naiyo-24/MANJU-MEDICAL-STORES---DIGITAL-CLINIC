...
class LabCreateTemplateScreen extends StatefulWidget {
  ...
  @override
  State<LabCreateTemplateScreen> createState() =>
      _LabCreateTemplateScreenState();
}
...
class _LabCreateTemplateScreenState extends State<LabCreateTemplateScreen> {
  ...
  void initState() {
    ...
    _clinicAddressCtrl = TextEditingController(
      text: _layoutConfig.clinicAddress,
    );
    ...
    _footerColorCtrl = TextEditingController(
      text: _layoutConfig.footerColorHex,
    );
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Design custom report template for your lab test',
                                style: TextStyle(
                                  fontSize: 14,
                                  color: Color(0xFF64748B),
                                ),
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              Text(
                                                _clinicNameCtrl.text.isNotEmpty
                                              ...
                                              Text(
                                                'Phone: ${_clinicPhoneCtrl.text}  |  Email: ${_clinicEmailCtrl.text}',
                                                style: const TextStyle(
                                                  fontSize: 10,
                                                  color: Color(0xFF64748B),
                                                ),
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              ...
                                              _DocVarRow(
                                                ...
                                                val: ': 09 Sep 2026 09:30 AM',
                                              ),
                                              _DocVarRow(
                                                label: 'Reporting Date',
                                                val: ': 09 Sep 2026 04:15 PM',
                                              ),
                                            ],
                                          ),
                                        ],
                                    ...
                                    Text(
                                      _testNameCtrl.text.isEmpty
                                          ? 'TEST NAME'
                                          : _testNameCtrl.text.toUpperCase(),
                                      style: const TextStyle(
                                        fontSize: 12,
                                        fontWeight: FontWeight.bold,
                                        color: Color(0xFF1E293B),
                            ...
                            child: Column(
                              ...
                              children: [
                                SizedBox(
                                  height: 600,
                                  child: leftColumn,
                                ), // Fixed height to allow inner scroll
                                const SizedBox(height: 24),
                                rightColumn,
                              ],
                            ),
