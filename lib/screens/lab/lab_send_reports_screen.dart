...
class _LabSendReportsScreenState extends State<LabSendReportsScreen> {
  ...
  Widget build(BuildContext context) {
    int pendingToSend = _reports
        .where((r) => r.status == 'Ready' && !r.isSent)
        .length;
    int sent = _reports.where((r) => r.isSent).length;

    List<LabReport> displayedReports = _reports.where((r) {
      if (_selectedTab == 'Pending to Send' &&
          (r.status != 'Ready' || r.isSent)) {
        return false;
      }
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: const [
                      ...
                      SizedBox(height: 4),
                      Text(
                        'Deliver lab reports to patients via WhatsApp, Email or SMS',
                        style: TextStyle(
                          fontSize: 14,
                          color: Color(0xFF64748B),
                        ),
                    ...
                    children: [
                          ...
                          children: [
                            Wrap(
                              ...
                              children: _tabs.map((tab) {
                                ...
                                String tabLabel = tab;
                                if (tab == 'Pending to Send') {
                                  tabLabel += ' ($pendingToSend)';
                                }
                        ...
                        child: Wrap(
                          ...
                          children: [
                            Container(
                              ...
                              child: TextField(
                                ...
                                decoration: const InputDecoration(
                                  hintText:
                                      'Search by patient name, booking ID, sample ID...',
                                  hintStyle: TextStyle(
                            ...
                            ElevatedButton.icon(
                              ...
                              label: Text(
                                'Send Reports (${_selectedReportIds.length})',
                              ),
                              style: ElevatedButton.styleFrom(
                                backgroundColor: const Color(
                                  0xFFE2E8F0,
                                ), // Disabled color style per screenshot
                                foregroundColor: Colors.white,
                                elevation: 0,
                      ...
                      _isLoading
                          ...
                          : ListView.separated(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                final isChecked = _selectedReportIds.contains(
                                  report.id,
                                );
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Expanded(
                                          flex: 3,
                                          child: Text(
                                            report.patientPhone.replaceAll(
                                              '+91 ',
                                              '',
                                            ),
                                            style: const TextStyle(
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              'Showing 1 to ${displayedReports.length} of $pendingToSend reports',
                              style: const TextStyle(
                                color: Color(0xFF64748B),
                                fontSize: 13,
                              ),
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          '${_selectedReport?.patientAge ?? '45 Years'} / ${_selectedReport?.patientGender ?? 'Male'}',
                                          style: const TextStyle(
                                            fontSize: 12,
                                            color: Color(0xFF64748B),
                                          ),
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            const SizedBox(width: 6),
                                            Text(
                                              '${_selectedReport?.patientName.toLowerCase().replaceAll(' ', '.') ?? 'suman.roy'}@example.com',
                                              style: const TextStyle(
                                                fontSize: 12,
                                                color: Color(0xFF1E3A8A),
                                              ),
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        _selectedReport?.testsPackageName ??
                                            'Full Body Checkup',
                                        style: const TextStyle(
                                          fontSize: 13,
                                          fontWeight: FontWeight.w500,
          ...
          Row(
            children: [
              _buildQuickAction(
                Icons.wechat,
                'Quick Send',
                'Send reports instantly via WhatsApp',
              ),
              const SizedBox(width: 16),
              _buildQuickAction(
                Icons.group,
                'Bulk Send',
                'Send multiple reports at once',
              ),
              const SizedBox(width: 16),
              _buildQuickAction(
                Icons.history,
                'Track Delivery',
                'View sent reports and delivery status',
              ),
            ],
          ),
        ],
