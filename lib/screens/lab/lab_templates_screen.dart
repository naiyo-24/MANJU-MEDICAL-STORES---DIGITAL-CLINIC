...
class _LabTemplatesScreenState extends State<LabTemplatesScreen> {
  ...
  Future<void> _navigateToCreateTemplate({
    LabTemplate? existingTemplate,
  }) async {
  ...
  Widget build(BuildContext context) {
    final filteredTemplates = _templates
        ...
        .toList();
    final totalPages =
        (filteredTemplates.length + _itemsPerPage - 1) ~/ _itemsPerPage;
    if (_currentPage > totalPages && totalPages > 0) _currentPage = totalPages;
    final startIndex = filteredTemplates.isEmpty
        ? 0
    ...
    final paginatedTemplates = filteredTemplates.isEmpty
        ? <LabTemplate>[]
        : filteredTemplates.sublist(startIndex, endIndex);
                    ...
                    children: [
                              ...
                              child: Container(
                                ...
                                child: TextField(
                                  ...
                                  decoration: const InputDecoration(
                                    hintText:
                                        'Search template name, test or category...',
                                    hintStyle: TextStyle(
                                        ...
                                        SizedBox(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              InkWell(
                                                onTap: () async {
                                                  final cloneJson = template
                                                      .toJson();
                                                  cloneJson['id'] = const Uuid()
                                                      .v4();
                                                  cloneJson['name'] =
                                                      '${template.name} (Copy)';
                                                  final clone =
                                                      LabTemplate.fromJson(
                                                        cloneJson,
                                                      );
                                                  await LabDataService.saveTemplate(
                                                    clone,
                                                  );
                                                  _loadData();
                                                },
                                              ...
                                              InkWell(
                                                onTap: () async {
                                                  ...
                                                  if (confirm == true) {
                                                    await LabDataService.deleteTemplate(
                                                      template.id,
                                                    );
                                                    if (_selectedTemplate?.id ==
                                                        template.id) {
                      ...
                      Padding(
                        ...
                        child: Wrap(
                          ...
                          children: [
                            Text(
                              'Showing ${filteredTemplates.isEmpty ? 0 : startIndex + 1} to $endIndex of ${filteredTemplates.length} templates',
                              style: const TextStyle(
                                color: Color(0xFF64748B),
                                fontSize: 13,
                              ),
  ...
  Widget _buildSelectedTabContent() {
    if (_selectedTemplate == null) {
      return const Center(child: Text('Select a template'));
    }
      ...
      children: [
                ...
                Row(
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: _selectedTemplate!.isActive
            ...
            ElevatedButton.icon(
              onPressed: () async {
                final refresh = await Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => LabCreateTemplateScreen(
                      existingTemplate: _selectedTemplate,
                    ),
                  ),
                );
        ...
        Row(
          ...
          children: [
            ...
            Text(
              '${_selectedTemplate!.fields.length} parameters',
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          flex: 3,
                          child: Text(
                            f.normalRange.isNotEmpty ? f.normalRange : '-',
                            style: const TextStyle(
                              fontSize: 13,
                              color: Color(0xFF64748B),
                            ),
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              _buildInfoRow(
                'Header Clinic Name',
                _selectedTemplate!.layoutConfig.clinicName,
              ),
              const SizedBox(height: 8),
              _buildInfoRow(
                'Show Patient Details',
                _selectedTemplate!.showPatientDetails ? 'Yes' : 'No',
              ),
              const SizedBox(height: 8),
              _buildInfoRow(
                'Show QR & PlayStore',
                _selectedTemplate!.layoutConfig.qrCodeUrl.isNotEmpty
                    ? 'Yes'
                    : 'No',
              ),
            ],
