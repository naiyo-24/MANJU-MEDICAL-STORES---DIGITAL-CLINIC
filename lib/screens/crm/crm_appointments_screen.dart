...
class CrmAppointmentsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<CrmAppointmentsScreen> createState() =>
      _CrmAppointmentsScreenState();
}
...
class _CrmAppointmentsScreenState extends ConsumerState<CrmAppointmentsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_appointments.isNotEmpty && _selectedAppointment == null) {
      _selectedAppointment = _appointments.length > 1
          ? _appointments[1]
          : _appointments.first;
    }
            ...
            children: [
              ...
              Column(
                ...
                children: const [
                  ...
                  SizedBox(height: 4),
                  Text(
                    'Schedule, manage and track doctor appointments',
        ...
        children: [
                ...
                return SingleChildScrollView(
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(
                        width: 150,
                        child: _buildDropdown('All Doctors', null),
                      ),
                      const SizedBox(width: 12),
                      SizedBox(
                        width: 150,
                        child: _buildDropdown('All Status', null),
                      ),
                      const SizedBox(width: 12),
                      TextButton(
                        onPressed: () {},
                        ...
                        Expanded(
                          child: ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              final isSelected =
                                  _selectedAppointment?.id == apt.id;
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Expanded(
                                        flex: 1,
                                        child: _buildStatusPill(apt.status),
                                      ),
                                      SizedBox(
                                        width: 100,
                                        child: Row(
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                const Text(
                  'Showing 1 to 10 of 86 appointments',
                    ...
                    children: [
                      ...
                      Expanded(
                        ...
                        child: Align(
                          ...
                          child: _buildStatusPill(apt.paymentStatus),
                        ),
                      ),
                    ],
                  ),
