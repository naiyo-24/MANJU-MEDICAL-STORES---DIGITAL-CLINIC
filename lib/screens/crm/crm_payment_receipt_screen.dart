                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              padding: const EdgeInsets.all(12),
                              decoration: BoxDecoration(border: Border.all(color: const Color(0xFFE2E8F0)), borderRadius: BorderRadius.circular(8)),
                              child: const Text('Thank you for choosing Manju Medical Stores & Digital Clinic.', style: TextStyle(color: Color(0xFF1E293B), fontSize: 13)),
                            ),
                          ],
                        ),
                      ),
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: const [
                              ...
                              SizedBox(height: 4),
                              Text('Your Health • Our Priority', style: TextStyle(fontSize: 10, fontStyle: FontStyle.italic, color: Color(0xFF64748B))),
                            ],
                          ),
                        ],
                      ),
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: const [
                              ...
                              Text('Manju Medical Stores & Digital Clinic.', style: TextStyle(fontSize: 9, color: Color(0xFF64748B))),
                            ],
                          ),
                        ],
                      ),
