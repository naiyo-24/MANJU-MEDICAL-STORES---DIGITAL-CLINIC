            ...
            children: [
              ...
              Column(
                ...
                children: const [
                  ...
                  SizedBox(height: 4),
                  Text(
                    'Create and send lab test requests to partner laboratories',
              ...
              child: Column(
                ...
                children: [
                        ...
                        child: Container(
                          ...
                          child: const TextField(
                            decoration: InputDecoration(
                              hintText:
                                  'Search test by name or code (e.g. CBC, LFT, HbA1c...)',
                              hintStyle: TextStyle(
                                fontSize: 13,
                                ...
                                ..._selectedTests.asMap().entries.map((entry) {
                                  ...
                                  return Container(
                                    ...
                                    decoration: BoxDecoration(
                                      border: Border(
                                        bottom: BorderSide(
                                          color: i == _selectedTests.length - 1
                                              ? Colors.transparent
                                              : const Color(0xFFE2E8F0),
                                        ),
                                      ),
                  ...
                  Container(
                    ...
                    child: const Text(
                      'Please collect the sample and process urgently. Patient is fasting.',
                ...
                children: [
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                            ...
                            Expanded(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  _buildPreviewDetailRow(
                                    'Notes',
                                    ': Please collect the sample and\n  process urgently. Patient is fasting.',
                                    isMultiLine: true,
                                  ),
                                ],
                              ),
                        ...
                        const Text(
                          'Kindly share the report via email or our online portal. For any queries, please contact us.',
                          style: TextStyle(
                            fontSize: 10,
                            color: Color(0xFF1E293B),
                          ),
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: const [
                        Text(
                          'Thank you for your support in delivering better healthcare.',
                          style: TextStyle(
                            fontSize: 10,
                            color: Color(0xFF8B5CF6),
