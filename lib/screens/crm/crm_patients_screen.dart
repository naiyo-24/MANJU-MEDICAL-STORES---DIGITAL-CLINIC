...
class _CrmPatientsScreenState extends ConsumerState<CrmPatientsScreen> {
  ...
  List<CrmPatient> get _filteredPatients {
    return _patients.where((p) {
      ...
      if (_selectedGender != 'All Gender' && p.gender != _selectedGender) {
        return false;
      }
      ...
      if (_selectedAge != 'All Age Groups') {
        ...
        if (_selectedAge == '19-35 Years' && (p.age < 19 || p.age > 35)) {
          return false;
        }
        if (_selectedAge == '36-60 Years' && (p.age < 36 || p.age > 60)) {
          return false;
        }
              ...
              actions: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    ...
                    await ref
                        .read(crmPatientsProvider.notifier)
        ...
        children: [
                  ...
                  children: [
                    ...
                    _buildActionButton(
                      ...
                      onTap: () {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('Exporting patients list to CSV...'),
                          ),
                        );
                      },
                    ),
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: _buildFilterDropdown(
                          'All Status',
                          ['All Status', 'Active', 'Inactive', 'Follow Up'],
                          _selectedStatus,
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Expanded(
                                        flex: 1,
                                        child: _buildStatusPill(patient.status),
                                      ),
                                      SizedBox(
                                        width: 100,
                                        child: Row(
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                const Text(
                  'Showing 1 to 10 of 1,248 patients',
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    _buildDemographicInfo(
                      DateFormat('dd MMM yyyy').format(p.lastVisit),
                      'Last Visit',
                    ),
                  ],
                ),
                    ...
                    (note) => Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            '${note.author}  |  ${DateFormat('dd MMM yyyy, hh:mm a').format(note.createdAt)}',
                            style: const TextStyle(
                              color: Color(0xFF94A3B8),
                              fontSize: 11,
                            ),
